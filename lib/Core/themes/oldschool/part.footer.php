<div class="p-1 border border-black rounded-lg bg-slate-300 shadow-md shadow-black my-5">
    ...
    <p class="text-center text-gray-500 text-sm">
        ...
        licensed under the <a href="https://github.com/H33Tx/ravatar/blob/main/LICENSE" class="underline text-blue-500 hover:text-blue-800" target="_blank">GNU General Public License v3.0</a>.
        Font <a href="https://fonts.google.com/specimen/Caudex" class="underline text-blue-500 hover:text-blue-800" target="_blank">Caudex by Nidud</a> through <a href="https://fonts.google.com" class="underline text-blue-500 hover:text-blue-800" target="_blank">Google Fonts</a>.
    </p>
</div>
